...
```
1. 리눅스
   서버 운영 환경으로 리눅스를 사용하여 안정적이고 효율적인 서버 운영을 지원합니다.
...
7. Node.js  
   서버 측에서 JavaScript 실행을 위한 Node.js를 사용하여 서버 로직을 처리합니다.

8. Express.js  
   Node.js의 웹 서버 프레임워크로 Express.js를 사용하여 API 서버를 구축하고, 요청과 응답을 처리합니다.

9. Socket.io  
   실시간 통신을 위한 웹 소켓 서버 구현에 `Socket.io` 라이브러리를 사용하여 클라이언트와 서버 간의 실시간 데이터 전송을 처리합니다.

10. MariaDB 제어  
    C 라이브러리인 `mysql.h`를 사용하여 MariaDB와 연동하여 데이터베이스 작업을 수행합니다.
